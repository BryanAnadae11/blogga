# Generated by Django 3.2 on 2024-05-16 14:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bloggabankapp.client')),
            ],
        ),
        migrations.CreateModel(
            name='History',
            fields=[
                ...
                ('amount', models.FloatField(blank=True, null=True)),
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bloggabankapp.client')),
            ],
        ),
        migrations.CreateModel(
